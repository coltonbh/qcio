...
def test_input_to_qcel(prog_input):
...
def test_input_to_output_from_qcel_output_with_wfn(prog_input):
    """Test that input converts to qcel input"""
    pi_energy = prog_input("energy")
...
def test_input_to_output_from_qcel_output_no_wfn(prog_input):
    """Test that input converts to qcel input"""
    prog_input_energy = prog_input("energy")
    qcel_atomic_input = AtomicInput(**to_qcel_input(prog_input_energy))

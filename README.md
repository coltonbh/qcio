...
Core physical constants are available in `constants` module. The source for all values is documented and kept up-to-date with the latest NIST/CODATA2022 values.

Input structures for specifying quantum chemistry calculations. The most commonly used structure is a `CalcInput` which tells a single program how to run a calculation.
